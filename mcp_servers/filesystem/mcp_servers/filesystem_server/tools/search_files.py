...
def search_files(
    pattern: Annotated[
        str,
        Field(
            description="Glob pattern (not regex) to match filenames. Uses shell-style wildcards: * matches any characters, ? matches single character. Examples: *.json, *.py, report_*.csv"
        ),
    ],
    path: Annotated[
        str,
