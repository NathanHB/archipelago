...
def read_text_file(
    ...
    max_size: Annotated[
        int,
        Field(
            description="DEPRECATED: This parameter is ignored. All file sizes are now supported with a warning logged for files over 3GB."
        ),
    ] = 0,
) -> str:
    """Read a text file from the filesystem; supports code, config, and documentation files."""
